...
and closure registration) and 2026-06-15 (N13 Matched P2.5 Writer / P4 Reader Reconciliation v0.1 promotion and closure registration; N14 gravity_correction Automatic-Canon Audit-First Reconciliation v0.1 promotion and closure registration). Amendments are small docs slices with trio sign-off.*
