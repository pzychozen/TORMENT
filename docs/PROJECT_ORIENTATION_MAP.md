...
PHASE_0A_EXTERNAL_SCOPE_CREATION_AUTHORITY = NEXT_POLICY_FREEZE
PHASE_0B_ACTIVE_PRODUCTION_POST_WRITE_PROFILE = NEXT_POLICY_FREEZE
REAL_ROOT_ACTIVATION_AUTHORIZED = NO
REAL_PRODUCTION_CUTOVER_AUTHORIZED = NO
NEXT_ACTION = PHASE_0_POLICY_RESOLUTION_BEFORE_ANY_9D_IMPLEMENTATION
```
