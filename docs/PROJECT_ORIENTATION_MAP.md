...
**ambiguity-threshold provenance lock** (`d2e26cd`) — corrects the misleading comment and test-locks the
intentional 0.60-fallback vs 0.72-primary distinction; **no threshold value or behavior changed**. **Each
leaf is a leaf, not the programme.**
